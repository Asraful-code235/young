...
export function ChildTherapy() {
  return (
    <section className="~pb-16/20">
      <div className="max-w-[1440px] w-full mx-auto ~px-5/16">
      ...
      <div className="space-y-8 ~py-8/16 lg:overflow-hidden max-w-[1310px] mx-auto ~px-5/16">
      ...
      <div className="max-w-[1360px] mx-auto ~px-5/16 ~py-8/16">
        <TwoGridSection

...
const FaqData = {
  ...
  accordion: [
    {
      title: "How long dose Irauma therapy tpically  last ?",
      description:
    ...
    {
      title:
        "Can Irauma therapy help children who don’t talk about their trauma?",
      description:
    ...
    {
      title: "Is Irauma therapy available virtually ?",
      description:
